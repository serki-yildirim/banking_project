...
/**
 * JDBC class is used to interact with our MYSQL Database to perform activities such as retrieving and updating
 * our db
 */
public class MyJDBC {
    /**
    ...
    public static User validateLogin(String username, String password) {
        try {
             ...
             * parameters index referring to the iteration of the ? so 1 is the first and
             * 2 is the second ?
             */
        ...
        try{
            ...
            while(resultSet.next()) {
                ...
                User transferredUser = new User(
                        resultSet.getInt("id"),
                        transferredUsername, resultSet.getString("password"),
